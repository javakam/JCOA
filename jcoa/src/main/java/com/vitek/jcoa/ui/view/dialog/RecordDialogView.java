 ...
 * @version 1.0
 */
public class RecordDialogView extends DialogManager implements OnClickListener {
	/**
	 * 麦克风的图标
	 */
	...
	public RecordDialogView(Context context, String savePath,ClickBackListener listener) {
		super(context);
		handler = new Handler();
