...
public class ApprovalStatusAdapter extends BaseListAdapter<ShowTaskEntity.ModelsBean> {
    private final static String NEXT_LINE = "\r\n";

    public ApprovalStatusAdapter(Context mContext, List<ShowTaskEntity.ModelsBean> mList, LayoutInflater mInflater) {
