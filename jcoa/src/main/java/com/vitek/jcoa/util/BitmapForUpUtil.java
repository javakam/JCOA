...
public class BitmapForUpUtil {
    ...
    private static String saveMyBitmap(String filename, Bitmap bit) {
        String baseDir = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Vitek/Cache/";
    ...
    public static String compressImageUpload(String path) {
        ...
        Bitmap image = getCompressImage(path);
    ...
    public static void deleteCacheFile() {
        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/Vitek/Cache/");
