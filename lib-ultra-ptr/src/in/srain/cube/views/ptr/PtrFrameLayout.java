...
public class PtrFrameLayout extends ViewGroup {
    ...
    protected void onFinishInflate() {
        ...
        if (childCount > 2) {
            ...
            errorView.setTextColor(0xffff6600);//橘红色
    ...
    protected void onLayout(boolean flag, int i, int j, int k, int l) {
        layoutChildren();//  java.lang.IndexOutOfBoundsException: Invalid index 7, size is 1
    }
    ...
    private void layoutChildren() {
        ...
        if (mContent != null) {
            ...
            mContent.layout(left, top, right, bottom);//  java.lang.IndexOutOfBoundsException: Invalid index 7, size is 1
        }
    }
